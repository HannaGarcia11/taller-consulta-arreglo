...
console.log("Playlist después de añadir la canción:", playlistInicial);
...
// Escribe tu código aquí
let titulosPlaylist = playlistInicial.map(cancion => cancion.titulo);
console.log("Nueva playlist con títulos:", titulosPlaylist);
...
// Escribe tu código aquí
let cancionesLargas = playlistInicial.filter(cancion => cancion.duracion > 400);
console.log("Nueva playlist con canciones > 400 segundos:", cancionesLargas);
console.log("Playlist original (sin cambios):", playlistInicial);
...
// Escribe tu código aquí
let cancionEagles = playlistInicial.find(cancion => cancion.artista === "Eagles");
console.log("Canción encontrada de Eagles:", cancionEagles);
console.log("Playlist original (sin cambios):", playlistInicial);
